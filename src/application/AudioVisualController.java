...
public class AudioVisualController 
{
	...
	{
		lblAnswer.setWrapText(true);
		lblClue.setWrapText(true);
		if(QuestionD.visualQuestions[QuestionD.visualButtonClicked][4].equals("image"))
		{
			btnPlay.setVisible(false);
			btnStop.setVisible(false);
			lblQuestionPane.setText(QuestionD.visualQuestions[QuestionD.visualButtonClicked][0]);
			imageView.setImage(new Image(QuestionD.visualQuestions[QuestionD.visualButtonClicked][1]));
			lblAnswer.setText(QuestionD.visualQuestions[QuestionD.visualButtonClicked][2]);
			lblClue.setText(QuestionD.visualQuestions[QuestionD.visualButtonClicked][3]);
		...
		{
			btnPlay.setVisible(true);
			String path=new File(QuestionD.visualQuestions[QuestionD.visualButtonClicked][1]).getAbsolutePath();
	...
	public void setAudioQuestion()
	{
			...
			lblAnswerAudio.setWrapText(true);
			btnStopAudio.setVisible(false);
			lblQuestionPaneAudio.setText(QuestionD.audioQuestions[QuestionD.audioButtonClicked][0]);
			lblAnswerAudio.setText(QuestionD.audioQuestions[QuestionD.audioButtonClicked][2]);
			lblClueAudio.setText(QuestionD.audioQuestions[QuestionD.audioButtonClicked][3]);
			
	}
	
	public void playAudioClicked()
	{
		String path=new File(QuestionD.audioQuestions[QuestionD.audioButtonClicked][1]).getAbsolutePath();
		media=new Media(new File(path).toURI().toString());
		mediaPlayer=new MediaPlayer(media);
		mediaPlayer.setOnEndOfMedia(()->{
			System.out.println("Called");
